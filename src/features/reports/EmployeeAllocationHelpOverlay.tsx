...
interface EmployeeAllocationHelpOverlayProps {
  open: boolean;
  onClose: () => void;
}

const EmployeeAllocationHelpOverlay: React.FC<EmployeeAllocationHelpOverlayProps> = ({
  open,
  onClose,
}) => {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto p-8 relative">
        ...
        <h3 className="text-lg font-semibold text-gray-800 mb-3">Data Sources & Key Fields</h3>
...
export default EmployeeAllocationHelpOverlay;
