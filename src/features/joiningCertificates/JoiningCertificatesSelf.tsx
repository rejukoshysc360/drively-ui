...
export default function JoiningCertificatesSelf() {
  ...
  if (!canViewOwn) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] text-gray-500 text-sm">
        You don’t have permission to view your joining certificates.
      </div>
    );
  }
  ...
  const downloadCertificate = useDownloadJoiningCertificatePDF();

  const { data, isLoading, isFetching, refetch } = useJoiningCertificates({
    page,
    limit,
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      toast.success("Joining certificate deleted successfully");
      refetch();
    } catch {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <ConfirmDialog
        open={!!deleteTarget}
        title="Delete Joining Certificate Request"
        description={`Are you sure you want to delete this joining certificate request? This cannot be undone.`}
        confirmLabel="Delete"
        danger
